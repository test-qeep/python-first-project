...
CREATE TABLE `blog` (
  ...
  `body` text,
  PRIMARY KEY (`id`),
  KEY `fk_blog_product_idx` (`product_id`),
  CONSTRAINT `fk_blog_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-11-29 11:45:01
